...
-- SQL Autograding Environment (v6): Global Company Database (EXAM 2)
...
/* practiceQuery1: Display the superssn, average salary, and the number of employees for each supervisor. Only consider employees with a supervisor. */
create or replace view practiceQuery1 as
select superssn, avg(salary), count(*) from employee where superssn is not null group by superssn;

/* practiceQuery2: Display dependent name, rating, department number, and department name for each intern with a rating greater than 7. */
 

/* practiceQuery3: Display the department number, balance, fund source id, and the remaining amount of funds for each budget. */


/* practiceQuery4: Display the customer id, location, and assets for all companies who have at least 200,000 more than the company with the lowest positive assets. */
...
INSERT INTO `magic44_expected_results` VALUES (0,1,'result#set#exists############'),(0,2,'result#set#exists############'),(0,3,'result#set#exists############'),(0,4,'result#set#exists############'),(1,1,'result#set#exists############'),(1,2,'result#set#exists############'),(1,3,'result#set#exists############'),(1,4,'result#set#exists############'),(2,1,'result#set#exists############'),(2,2,'result#set#exists############'),(2,3,'result#set#exists############'),(2,4,'result#set#exists############'),(3,1,'result#set#exists############'),(3,2,'result#set#exists############'),(3,3,'result#set#exists############'),(3,4,'result#set#exists############'),(4,1,'result#set#exists############'),(4,2,'result#set#exists############'),(4,3,'result#set#exists############'),(4,4,'result#set#exists############'),(0,1,'333445555#31000.0000#3############'),(0,1,'888665555#41500.0000#2############'),(0,1,'987654321#25000.0000#2############'),(0,2,'alice#8#4#administration###########'),(0,2,'michael#8#5#research###########'),(0,2,'alice#10#5#research###########'),(0,3,'1#170000#5#31000###########'),(0,3,'4#64000#############'),(0,3,'5#516000#17#61000###########'),(0,4,'bank3#newyork#417000############'),(0,4,'bank4#houston#619000############'),(0,4,'tech3#houston#850000############'),(1,1,'333445555#31000.0000#3############'),(1,1,'888665555#40000.0000#1############'),(1,2,'michael#8#5#research###########'),(1,2,'alice#10#5#research###########'),(1,3,'1#170000#5#31000###########'),(1,4,'bank3#newyork#417000############'),(2,1,'888665555#43000.0000#1############'),(2,1,'987654321#25000.0000#2############'),(2,3,'4#64000#############'),(2,4,'bank4#houston#619000############'),(2,4,'tech3#houston#850000############'),(3,1,'333445555#31000.0000#3############'),(3,1,'235711131#41750.0000#4############'),(3,1,'888665555#38000.0000#3############'),(3,1,'987654321#25000.0000#2############'),(3,2,'alice#8#4#administration###########'),(3,2,'michael#8#5#research###########'),(3,2,'alice#10#5#research###########'),(3,2,'ariel#8#5#research###########'),(3,2,'ariel#8#9#reverseengineering###########'),(3,3,'1#170000#5#31000###########'),(3,3,'4#64000#############'),(3,3,'5#516000#17#61000###########'),(3,3,'9#100000#31#66000###########'),(3,4,'bank3#newyork#417000############'),(3,4,'bank4#houston#619000############'),(3,4,'mgmt2#lubbock#415000############'),(3,4,'tech3#houston#850000############'),(4,1,'333445555#33000.0000#3############'),(4,1,'888665555#41500.0000#2############'),(4,1,'987654321#32500.0000#2############'),(4,2,'alice#8#4#administration###########'),(4,2,'michael#8#5#research###########'),(4,2,'alice#8#5#research###########'),(4,3,'1#160000#5#29000###########'),(4,3,'4#74000#############'),(4,3,'5#506000#17#59000###########'),(4,4,'bank4#houston#649000############'),(4,4,'tech3#houston#840000############');
-- --[%v%0%6%]--------------------------------------
-- autograding system
-- -------------------------------------------------
