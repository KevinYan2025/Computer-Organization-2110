 ...
 * 
    ...
    REFER TO THIS FILE FOR DOCUMENTATION ON THE FUNCTIONS TO IMPLEMENT IN ARRAYLIST.C
    You do not need to edit or submit this file to gradescope.
    Edited by Rushil Sudunagunta 02/08/2024
*/
